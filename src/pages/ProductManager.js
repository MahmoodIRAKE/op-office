...
const TABLE_HEAD = [
  ...
  { id: 'desc', label: 'Descreption', alignRight: false },
  { id: 'category', label: 'Category', alignRight: false },
  { id: 'image', label: 'Image', alignRight: false },
  { id: 'price', label: 'Price', alignRight: false },
  { id: 'qty', label: 'Quntity', alignRight: false },
...
export default function ProductsPage() {
  ...
  const handleClickNewUser=()=>{
    navigate('/dashboard/product-form', { replace: true ,state:{user:null}});
  }


  const handleActive=(product)=>{
    ProductsServices.updateProductActive(product,setShowLoader,setError,()=>{},product.id,!product.active)
...
const findCategoryname=(id)=>{
    if(categoreis){
        return categoreis.find(a=>a.id===id)
    }
    return 'default'
}
...
const handleEditclick=(product)=>{
  ...
  const handleDelete= (id)=>{
    ProductsServices.deleteProducts(setShowLoader,setProducts,setError,id)
  }
  ...
  return (
    <>
      ...
      >
        <MenuItem onClick={()=>handleEditclick(productToEdit)}>
          <Iconify icon={'eva:edit-fill'} sx={{ mr: 2 }} />
          Edit
        </MenuItem>

        <MenuItem sx={{ color: 'error.main' }} onClick={()=>handleDelete(productToEdit.id)}>
